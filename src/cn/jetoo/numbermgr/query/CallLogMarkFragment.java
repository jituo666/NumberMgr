...
import cn.jetoo.numbermgr.intercept.pick.PickCallLogAdapter;
import cn.jetoo.numbermgr.utils.FeatureConfig;
import cn.jetoo.numbermgr.utils.LogHelper;

public class CallLogMarkFragment extends Fragment{
    ...
    private class LoadDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            mPickList = PickContent.queryCallLogList(getActivity());
            return null;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new PickCallLogAdapter(getActivity(), false);
